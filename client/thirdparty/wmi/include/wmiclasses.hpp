...
struct Win32_ComputerSystem
{
	...
	Win32_ComputerSystem() :
		...
		ResetCapability(), ResetCount(), ResetLimit(), Roles(), Status(), SupportContactDescription(), SystemStartupDelay(), SystemFamily(), SystemSKUNumber(),
	...
	void setProperties(const WmiResult &result, std::size_t index)
	{
		...
		result.extract(index,"SystemSKUNumber", (*this).SystemSKUNumber);
		result.extract(index,"SystemFamily", (*this).SystemFamily);
...
struct Win32_PhysicalMemory
{
	Win32_PhysicalMemory() :
		Attributes(), BankLabel(), Capacity(), Caption(), ConfiguredClockSpeed(), ConfiguredVoltage(),
		CreationClassName(), DataWidth(), DeviceLocator(), FormFactor(), HotSwappable(), InstallDate(), InterleaveDataDepth(),
		InterleavePosition(), Manufacturer(), MaxVoltage(), MemoryType(), MinVoltage(),
		Model(), Name(), OtherIdentifyingInfo(), PartNumber(), PositionInRow(),
		PoweredOn(), Removable(), Replaceable(), SerialNumber(), SKU(),
		SMBIOSMemoryType(), Speed(), Status(), Tag(), TotalWidth(),
		TypeDetail(), Version()
	{
	}
	...
	void setProperties(const WmiResult& result, std::size_t index)
	{
		result.extract(index, "Attributes", (*this).Attributes);
		result.extract(index, "BankLabel", (*this).BankLabel);
		result.extract(index, "Capacity", (*this).Capacity);
		result.extract(index, "Caption", (*this).Caption);
		result.extract(index, "ConfiguredClockSpeed", (*this).ConfiguredClockSpeed);
		result.extract(index, "ConfiguredVoltage", (*this).ConfiguredVoltage);
		result.extract(index, "CreationClassName", (*this).CreationClassName);
		result.extract(index, "DataWidth", (*this).DataWidth);
		result.extract(index, "Description", (*this).Description);
		result.extract(index, "DeviceLocator", (*this).DeviceLocator);
		result.extract(index, "FormFactor", (*this).FormFactor);
		result.extract(index, "HotSwappable", (*this).HotSwappable);
		result.extract(index, "InstallDate", (*this).InstallDate);
		result.extract(index, "InterleaveDataDepth", (*this).InterleaveDataDepth);
		result.extract(index, "InterleavePosition", (*this).InterleavePosition);
		result.extract(index, "Manufacturer", (*this).Manufacturer);
		result.extract(index, "MaxVoltage", (*this).MaxVoltage);
		result.extract(index, "MemoryType", (*this).MemoryType);
		result.extract(index, "MinVoltage", (*this).MinVoltage);
		result.extract(index, "Model", (*this).Model);
		result.extract(index, "Name", (*this).Name);
		result.extract(index, "OtherIdentifyingInfo", (*this).OtherIdentifyingInfo);
		result.extract(index, "PartNumber", (*this).PartNumber);
		result.extract(index, "PositionInRow", (*this).PositionInRow);
		result.extract(index, "PoweredOn", (*this).PoweredOn);
		result.extract(index, "Removable", (*this).Removable);
		result.extract(index, "Replaceable", (*this).Replaceable);
		result.extract(index, "SerialNumber", (*this).SerialNumber);
		result.extract(index, "SKU", (*this).SKU);
		result.extract(index, "SMBIOSMemoryType", (*this).SMBIOSMemoryType);
		result.extract(index, "Speed", (*this).Speed);
		result.extract(index, "Status", (*this).Status);
		result.extract(index, "Tag", (*this).Tag);
		result.extract(index, "TotalWidth", (*this).TotalWidth);
		result.extract(index, "TypeDetail", (*this).TypeDetail);
		result.extract(index, "Version", (*this).Version);
	}
...
{
	Win32_DiskDrive() :
		Availability(), BytesPerSector(), Capabilities(), CapabilityDescriptions(), Caption(), CompressionMethod(),
		ConfigManagerErrorCode(), ConfigManagerUserConfig(), CreationClassName(), DefaultBlockSize(), Description(),
		DeviceID(), ErrorCleared(), ErrorDescription(), ErrorMethodology(), FirmwareRevision(), Index(),
		InstallDate(), InterfaceType(), LastErrorCode(), Manufacturer(), MediaLoaded(), MediaType(), Model(),
		Name(), Partitions(), PNPDeviceID(), PowerManagementCapabilities(), PowerManagementSupported(),
	...
	{
		result.extract(index, "Availability", (*this).Availability);
		result.extract(index, "BytesPerSector", (*this).BytesPerSector);
		result.extract(index, "Capabilities", (*this).Capabilities);
		result.extract(index, "CapabilityDescriptions", (*this).CapabilityDescriptions);
		result.extract(index, "Caption", (*this).Caption);
		result.extract(index, "CompressionMethod", (*this).CompressionMethod);
		result.extract(index, "ConfigManagerErrorCode", (*this).ConfigManagerErrorCode);
		result.extract(index, "ConfigManagerUserConfig", (*this).ConfigManagerUserConfig);
		result.extract(index, "CreationClassName", (*this).CreationClassName);
		result.extract(index, "DefaultBlockSize", (*this).DefaultBlockSize);
		result.extract(index, "Description", (*this).Description);
		result.extract(index, "DeviceID", (*this).DeviceID);
		result.extract(index, "ErrorCleared", (*this).ErrorCleared);
		result.extract(index, "ErrorDescription", (*this).ErrorDescription);
		result.extract(index, "ErrorMethodology", (*this).ErrorMethodology);
		result.extract(index, "FirmwareRevision", (*this).FirmwareRevision);
		result.extract(index, "Index", (*this).Index);
		result.extract(index, "InstallDate", (*this).InstallDate);
		result.extract(index, "InterfaceType", (*this).InterfaceType);
		result.extract(index, "LastErrorCode", (*this).LastErrorCode);
		result.extract(index, "Manufacturer", (*this).Manufacturer);
		result.extract(index, "MediaLoaded", (*this).MediaLoaded);
		result.extract(index, "MediaType", (*this).MediaType);
		result.extract(index, "Model", (*this).Model);
		result.extract(index, "Name", (*this).Name);
		result.extract(index, "Partitions", (*this).Partitions);
		result.extract(index, "PNPDeviceID", (*this).PNPDeviceID);
		result.extract(index, "PowerManagementCapabilities", (*this).PowerManagementCapabilities);
		result.extract(index, "PowerManagementSupported", (*this).PowerManagementSupported);
		result.extract(index, "SCSIBus", (*this).SCSIBus);
		result.extract(index, "SCSILogicalUnit", (*this).SCSILogicalUnit);
		result.extract(index, "SCSIPort", (*this).SCSIPort);
		result.extract(index, "SCSITargetId", (*this).SCSITargetId);
		result.extract(index, "SectorsPerTrack", (*this).SectorsPerTrack);
		result.extract(index, "SerialNumber", (*this).SerialNumber);
		result.extract(index, "Signature", (*this).Signature);
		result.extract(index, "Size", (*this).Size);
		result.extract(index, "Status", (*this).Status);
		result.extract(index, "StatusInfo", (*this).StatusInfo);
		result.extract(index, "SystemCreationClassName", (*this).SystemCreationClassName);
		result.extract(index, "SystemName", (*this).SystemName);
		result.extract(index, "TotalCylinders", (*this).TotalCylinders);
		result.extract(index, "TotalHeads", (*this).TotalHeads);
		result.extract(index, "TotalSectors", (*this).TotalSectors);
		result.extract(index, "TotalTracks", (*this).TotalTracks);
		result.extract(index, "TracksPerCylinder", (*this).TracksPerCylinder);
	}
...
struct Win32_NetworkAdapter
{
	Win32_NetworkAdapter() :
		AdapterType(), AdapterTypeID(), AutoSense(), Availability(), Caption(), ConfigManagerErrorCode(), ConfigManagerUserConfig(),
		CreationClassName(), Description(), DeviceID(), ErrorCleared(), ErrorDescription(), GUID(), Index(), InstallDate(),
		Installed(), InterfaceIndex(), LastErrorCode(), MACAddress(), Manufacturer(), MaxNumberControlled(), MaxSpeed(), Name(),
		NetConnectionID(), NetConnectionStatus(), NetEnabled(), NetworkAddresses(), PermanentAddress(), PhysicalAdapter(),
		PNPDeviceID(), PowerManagementCapabilities(), PowerManagementSupported(), ProductName(), ServiceName(), Speed(), Status(),
		StatusInfo(), SystemCreationClassName(), SystemName(), TimeOfLastReset()
	{
	}
	...
	void setProperties(const WmiResult& result, std::size_t index)
	{
		result.extract(index, "AdapterType", (*this).AdapterType);
		result.extract(index, "AdapterTypeID", (*this).AdapterTypeID);
		result.extract(index, "AutoSense", (*this).AutoSense);
		result.extract(index, "Availability", (*this).Availability);
		result.extract(index, "Caption", (*this).Caption);
		result.extract(index, "ConfigManagerErrorCode", (*this).ConfigManagerErrorCode);
		result.extract(index, "ConfigManagerUserConfig", (*this).ConfigManagerUserConfig);
		...
		result.extract(index, "ErrorCleared", (*this).ErrorCleared);
		result.extract(index, "ErrorDescription", (*this).ErrorDescription);
		result.extract(index, "GUID", (*this).GUID);
		result.extract(index, "Index", (*this).Index);
		result.extract(index, "InstallDate", (*this).InstallDate);
		result.extract(index, "Installed", (*this).Installed);
		result.extract(index, "InterfaceIndex", (*this).InterfaceIndex);
		result.extract(index, "LastErrorCode", (*this).LastErrorCode);
		result.extract(index, "MACAddress", (*this).MACAddress);
		result.extract(index, "Manufacturer", (*this).Manufacturer);
		result.extract(index, "MaxNumberControlled", (*this).MaxNumberControlled);
		result.extract(index, "MaxSpeed", (*this).MaxSpeed);
		result.extract(index, "Name", (*this).Name);
		result.extract(index, "NetConnectionID", (*this).NetConnectionID);
		result.extract(index, "NetConnectionStatus", (*this).NetConnectionStatus);
		result.extract(index, "NetEnabled", (*this).NetEnabled);
		result.extract(index, "NetworkAddresses", (*this).NetworkAddresses);
		result.extract(index, "PermanentAddress", (*this).PermanentAddress);
		result.extract(index, "PhysicalAdapter", (*this).PhysicalAdapter);
		result.extract(index, "PNPDeviceID", (*this).PNPDeviceID);
		result.extract(index, "PowerManagementCapabilities", (*this).PowerManagementCapabilities);
		result.extract(index, "PowerManagementSupported", (*this).PowerManagementSupported);
		result.extract(index, "ProductName", (*this).ProductName);
		result.extract(index, "ServiceName", (*this).ServiceName);
		result.extract(index, "Speed", (*this).Speed);
		result.extract(index, "Status", (*this).Status);
		result.extract(index, "StatusInfo", (*this).StatusInfo);
		result.extract(index, "SystemCreationClassName", (*this).SystemCreationClassName);
	...
	std::string SystemName;
	std::string TimeOfLastReset;
}; // end class Win32_NetworkAdapter
