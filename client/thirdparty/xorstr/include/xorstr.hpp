...
namespace jm {
    ...
    namespace detail {
        ...
        {
            return value; // Simplified, no register optimization
        }
    ...
    public:
        ...
        XORSTR_FORCEINLINE void crypt() noexcept
        {
            ...
            // Simplified XOR without AVX or NEON intrinsics
            for (std::size_t i = 0; i < sizeof(_storage) / sizeof(std::uint64_t); ++i)
            {
                _storage[i] ^= keys[i];
            }
        }
